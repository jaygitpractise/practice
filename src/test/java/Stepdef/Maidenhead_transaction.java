...
public class Maidenhead_transaction {
	...
	public void i_am_a_registered_Agate_User_and_I_login_in_to_Maiadenhead(String browser) throws IOException, InterruptedException {
		...
		driver_Maidenhead_Transaction.get("https://www.maidenhead-advertiser.co.uk/news/remember-when/144446/remember-when-oliver-cast-back-for-more-and-cub-pack-welcomes-first-girls.html");
		Thread.sleep(3000);
		String popbitch_navigation= driver_Maidenhead_Transaction.getCurrentUrl();
	    try
		{
	    	AssertJUnit.assertTrue(popbitch_navigation.contains("https://www.maidenhead-advertiser.co.uk/news/remember-when/144446/remember-when-oliver-cast-back-for-more-and-cub-pack-welcomes-first-girls.html"));
	...
	public void i_read_a_premium_article_on_Maiadenhead() throws InterruptedException, IOException {
	...
	@Test(priority=14)
	@Then("The popbitch wallet balance is updated , same as Maiadenhead and free point remains uneffected")
	public void the_popbitch_wallet_balance_is_updated_same_as_Maiadenhead_and_free_point_remains_uneffected() throws InterruptedException, IOException {
	...
	@Test(priority=15)
	@Then("Reaction wallet balance is updated and free point remains uneffected same as Maiadenhead")
	public void reaction_wallet_balance_is_updated_and_free_point_remains_uneffected_same_as_Maiadenhead() throws InterruptedException, IOException {
	...
	@Test(priority=16)
	@Then("Cricketer wallet balance remains and is uneffected by Maiadenhead")
	public void cricketer_wallet_balance_remains_and_is_uneffected_by_Maiadenhead() throws InterruptedException, IOException {
	...
	@Test(priority=17)
	@Then("Cornwall wallet balance remains and is uneffected by Maiadenhead")
	public void cornwall_wallet_balance_remains_and_is_uneffected_by_Maiadenhead() throws InterruptedException, IOException {
	...
	public void slough_wallet_balance_remains_and_is_uneffected_by_Maiadenhead() throws InterruptedException, IOException {
		driver_Maidenhead_Transaction.navigate().to("https://www.sloughexpress.co.uk/news/remember-when/144177/remember-when-when-mary-had-a-little-lamb-and-the-outdoor-pool-closed-for-good.html");
		Thread.sleep(4000);
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
			pop_first_use_top_up_from_wallet2.click_on_green_tab();
	...
	public void slug_recognition_works_on_Slough() throws InterruptedException, IOException {
		...
		driver_Maidenhead_Transaction.navigate().to("https://www.sloughexpress.co.uk/news/remember-when/144446/remember-when-oliver-cast-back-for-more-and-cub-pack-welcomes-first-girls.html");
				Thread.sleep(4000);	
