...
public class Slough_Transaction {
	
	WebDriver driver_Maidenhead_Transaction;
	...
	public void i_am_a_registered_Agate_User_and_I_login_in_to_slough(String browser) throws IOException, InterruptedException {
		if(browser.equalsIgnoreCase("firefox")) {
			driver_Maidenhead_Transaction = new FirefoxDriver();
		}else if (browser.equalsIgnoreCase("safari")) { 

			driver_Maidenhead_Transaction= new SafariDriver();
		} 

		else if (browser.equalsIgnoreCase("chrome")) { 
			driver_Maidenhead_Transaction= new ChromeDriver();
		} 
		...
		driver_Maidenhead_Transaction.get("https://www.sloughexpress.co.uk/news/remember-when/144446/remember-when-oliver-cast-back-for-more-and-cub-pack-welcomes-first-girls.html");
		Thread.sleep(3000);
		String popbitch_navigation= driver_Maidenhead_Transaction.getCurrentUrl();
	    try
		{
	    	AssertJUnit.assertTrue(popbitch_navigation.contains("https://www.sloughexpress.co.uk/news/remember-when/144446/remember-when-oliver-cast-back-for-more-and-cub-pack-welcomes-first-girls.html"));
		...
		File scrFile = ((TakesScreenshot)driver_Maidenhead_Transaction).getScreenshotAs(OutputType.FILE);
		...
		Thread.sleep(15000);
		Thread.sleep(15000);
		Maidenhead_first_use_notice Maidenhead_f_u_n = new Maidenhead_first_use_notice(driver_Maidenhead_Transaction);
		...
		Thread.sleep(8000);
		File scrFile5 = ((TakesScreenshot)driver_Maidenhead_Transaction).getScreenshotAs(OutputType.FILE);
		...
		Thread.sleep(2000);
		String Login_From_PopBitch_Frist_Use_Notice_Current_Url= driver_Maidenhead_Transaction.getCurrentUrl();
	    ...
	    Login_Page_Elements Login_Pop_First_Use = new Login_Page_Elements(driver_Maidenhead_Transaction);
		Thread.sleep(2000);
		Login_Pop_First_Use.Login_Process("Ajjukanna1$$");
		Thread.sleep(10000);
		File scrFile6 = ((TakesScreenshot)driver_Maidenhead_Transaction).getScreenshotAs(OutputType.FILE);
	...
	public void i_read_a_premium_article_on_slough() throws InterruptedException, IOException {
		//click ok on authorise charge notice
		//scroll for full article
		JavascriptExecutor js0 = (JavascriptExecutor)driver_Maidenhead_Transaction;
		...
		Thread.sleep(10000);
				Authorise_charge_notice_popbitch authy_popbitch = new Authorise_charge_notice_popbitch(driver_Maidenhead_Transaction);
				authy_popbitch.authorise_charge_notice_click_continue();
				Thread.sleep(3000);
			
				
				//Click on the green tab and 
				PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
				pop_first_use_top_up_from_wallet2.click_on_green_tab();
				
				
				
			//check if the wallet is being deducted by 30 p
				Popbitch_Wallet_Elements_staging wallet_elements_1 = new Popbitch_Wallet_Elements_staging(driver_Maidenhead_Transaction);
	...
	@Test(priority=14)
	@Then("The popbitch wallet balance is updated , same as slough and free point remains uneffected")
	public void the_popbitch_wallet_balance_is_updated_same_as_slough_and_free_point_remains_uneffected() throws InterruptedException, IOException {
		driver_Maidenhead_Transaction.navigate().to("https://popbitch.com/2019/02/tat-for-tits/");
		Thread.sleep(4000);
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
			pop_first_use_top_up_from_wallet2.click_on_green_tab();
	...
	@Test(priority=15)
	@Then("Reaction wallet balance is updated and free point remains uneffected same as slough")
	public void reaction_wallet_balance_is_updated_and_free_point_remains_uneffected_same_as_slough() throws InterruptedException, IOException {
		driver_Maidenhead_Transaction.navigate().to("https://reaction.life/independent-groups-new-politics-isnt-new/");
		Thread.sleep(4000);
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
			pop_first_use_top_up_from_wallet2.click_on_green_tab();
	...
	@Test(priority=16)
	@Then("Cricketer wallet balance remains and is uneffected by slough")
	public void cricketer_wallet_balance_remains_and_is_uneffected_by_slough() throws InterruptedException, IOException {
		driver_Maidenhead_Transaction.navigate().to("https://www.thecricketer.com/Topics/premimum_features/stats_life_nathan_lyons_test_sixes_record_is_a_badge_of_honour.html");
		Thread.sleep(4000);
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
			pop_first_use_top_up_from_wallet2.click_on_green_tab();
	...
	@Test(priority=17)
	@Then("Cornwall wallet balance remains and is uneffected by slough")
	public void cornwall_wallet_balance_remains_and_is_uneffected_by_slough() throws InterruptedException, IOException {
		driver_Maidenhead_Transaction.navigate().to("https://cornwallreports.co.uk/cruel-december-radio-cornwall-back-in-the-doldrums-as-audience-figures-surrender-to-gravity/");
		Thread.sleep(4000);
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
			pop_first_use_top_up_from_wallet2.click_on_green_tab();
	...
	@Test(priority=18)
	@When("Maidenhead wallet balance remains and is uneffected by Slough")
	public void slough_wallet_balance_remains_and_is_uneffected_by_slough() throws InterruptedException, IOException {
		driver_Maidenhead_Transaction.navigate().to("https://www.maidenhead-advertiser.co.uk/news/remember-when/144177/remember-when-when-mary-had-a-little-lamb-and-the-outdoor-pool-closed-for-good.html");
		Thread.sleep(4000);
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
			pop_first_use_top_up_from_wallet2.click_on_green_tab();
	...
	@Test(priority=19)
	@When("Windsor wallet balance remains and is uneffected by slough")
	public void windsor_wallet_balance_remains_and_is_uneffected_by_slough() throws InterruptedException, IOException {
		driver_Maidenhead_Transaction.navigate().to("https://www.windsorexpress.co.uk/gallery/windsor/143020/public-inquiry-begins-into-proposed-development-on-former-imperial-house-site.html");
		Thread.sleep(4000);
		//Click on the green tab and 
			PopbitchFirstUseNoticeElements pop_first_use_top_up_from_wallet2 = new PopbitchFirstUseNoticeElements(driver_Maidenhead_Transaction);
			pop_first_use_top_up_from_wallet2.click_on_green_tab();
	...
	@Test(priority=20)
	@When("Slug recognition works on maidenhead from slough")
	public void slug_recognition_works_on_maidenhead_from_slough() throws InterruptedException, IOException {
		//Read a sixth article on cricketer
		driver_Maidenhead_Transaction.navigate().to("https://www.maidenhead-advertiser.co.uk/news/remember-when/144446/remember-when-oliver-cast-back-for-more-and-cub-pack-welcomes-first-girls.html");
				Thread.sleep(4000);	
				String popbitch_navigation2= driver_Maidenhead_Transaction.getCurrentUrl();
			    try
				{
	...
	@Test(priority=21)
	@When("Slug recognition works on Windsor from slough")
	public void slug_recognition_works_on_Windsor_from_slough() throws InterruptedException, IOException {
		//Read a sixth article on cricketer
				driver_Maidenhead_Transaction.navigate().to("https://www.windsorexpress.co.uk/news/remember-when/144446/remember-when-oliver-cast-back-for-more-and-cub-pack-welcomes-first-girls.html");
						Thread.sleep(4000);	
						String popbitch_navigation2= driver_Maidenhead_Transaction.getCurrentUrl();
					    try
						{
