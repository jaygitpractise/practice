...
public class Maidenhead_Login {
		...
		//INSTANTIATE WEBDRIVER
			...
			@Test(priority=6)
			@Parameters("browser")
		public void i_am_a_registered_user_of_Maidenhead_and_I_open_a_browser(String browser) {
		...
		@Test(priority=7)
		public void i_navigate_to_a_premium_article_on_Maidenhead() throws IOException, InterruptedException {
			//open a premium article on reaction	
			driver_Maidenhead_login_first_use_notice.get("https://www.maidenhead-advertiser.co.uk/gallery/maidenhead/144007/anger-as-councillors-asked-to-allow-leader-to-oversee-town-centre-sale.html");
					Thread.sleep(10000);
				...
				//verify that the premium article is opened	
				    ...
				    try
					{
				    	AssertJUnit.assertTrue(reaction_navigation.contains("https://www.maidenhead-advertiser.co.uk/gallery/maidenhead/144007/anger-as-councillors-asked-to-allow-leader-to-oversee-town-centre-sale.html"));
		...
		@Test(priority=8)
		public void i_click_on_Login_from_Maidenhead_First_use_notice() throws InterruptedException {
		...
		@Test(priority=9)
		public void i_verify_that_the_Login_Button_Navigates_me_to_the_login_page_to_log_me_in_to_Maidenhead() throws IOException, InterruptedException {
		...
		@Then("entering the correct email and password logs me in to Maidenhead")
		@Test(priority=10)
		public void entering_the_correct_email_and_password_logs_me_in_to_Maidenhead() throws IOException, InterruptedException {
		...
		@Then("verify that I am being navigated to thej  same article on Maidenhead")
		@Test(priority=11)
		public void verify_that_I_am_being_navigated_to_the_same_article_on_Maidenhead() throws IOException, InterruptedException {
			//scroll for first use notice
