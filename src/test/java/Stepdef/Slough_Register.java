...
public class Slough_Register {
	...
	@Test(priority=0)
	@Parameters("browser")
	public void i_am_not_a_user_of_agate_on_Slough_and_I_open_a_browser(String browser) {
	...
	@Test(priority=1)
	public void i_navigate_to_a_premium_article_on_Slough() throws InterruptedException {
		driver_Register_from_Maidenhead_first_use_notice.get("https://www.sloughexpress.co.uk/news/remember-when/143583/remember-when-tinker-model-railers-rowers-and-trail-blazers-at-lego-world.html");
		Thread.sleep(10000);
		String popbitch_navigation= driver_Register_from_Maidenhead_first_use_notice.getCurrentUrl();
	    try
		{
	    	AssertJUnit.assertTrue(popbitch_navigation.contains("https://www.sloughexpress.co.uk/news/remember-when/143583/remember-when-tinker-model-railers-rowers-and-trail-blazers-at-lego-world.html"));
	...
	@Given("I click on the create wallet button on Slough")
	@Test(priority=2)
	public void i_click_on_the_create_wallet_button_on_Slough() throws IOException, InterruptedException {
		Thread.sleep(3000);
		//Scroll by 200px
			...
			//Screen shot of browser navigated to article
				...
				FileUtils.copyFile(scrFile, new File("/Users/jay/Desktop/slough/"+"_"+timestamp+"_"+"jpg" ));	
	...
	@Given("I verify that the create wallet button takes me to the reg page on Slough")
	@Test(priority=3)
	public void i_verify_that_the_create_wallet_button_takes_me_to_the_reg_page_on_Slough() throws InterruptedException {
	...
	@Test(priority=4)
	public void i_enter_all_the_details_successfully_on_reg_page_on_slough() throws IOException, InterruptedException {
		//screenshot of reg page
			...
			//String screenshot_name_2= "Popbitch_FUN_to_Register_1";
				...
				FileUtils.copyFile(scrFile1, new File("/Users/jay/Desktop/slough/"+"_"+timestamp_2+"_"+"jpg" ));
	...
	@Test(priority=5)
	public void i_am_registered_as_an_agate_user_on_Slough_successfully_and_I_am_shown_a_first_use_notice() throws IOException, InterruptedException  {
		Thread.sleep(20000);
	    
	    
	    String Register_Elements_Expected_url= "https://www.sloughexpress.co.uk/news/remember-when/143583/remember-when-tinker-model-railers-rowers-and-trail-blazers-at-lego-world.html";
		...
		//Click off on finish notice and click on ok
			...
			FileUtils.copyFile(scrFile_2, new File("/Users/jay/Desktop/slough/"+"_"+timestamp_2+"_"+"jpg" ));
		...
		//Screen shot of article 1
			...
			FileUtils.copyFile(scrFile_3, new File("/Users/jay/Desktop/slough/"+"_"+timestamp_3+"_"+"jpg" ));
			Thread.sleep(3000);
		...
		//Screen shot of article 2
			...
			FileUtils.copyFile(scrFile_4, new File("/Users/jay/Desktop/slough/"+"_"+timestamp_4+"_"+"jpg" ));
		...
		//Screen shot of article 3		
			...
			FileUtils.copyFile(scrFile_5, new File("/Users/jay/Desktop/slough/"+"_"+timestamp_5+"_"+"jpg" ));
	}
